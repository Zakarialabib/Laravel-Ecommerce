            ...
            <div class="w-full lg:w-3/5 px-4 mb-20">
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-10 lg:mb-0">
                        <h3 class="mb-8 text-xl font-bold font-heading text-white border-b border-orange-400">
                            {{ __('Information') }}</h3>
                        <ul>
                            <li class="mb-6"><a class="text-gray-50 hover:text-gray-200" href="#">
                                    {{ __('Blog') }}
                                </a>
                            </li>
                            <li class="mb-6">
                                <a class="text-gray-50 hover:text-gray-200"
                                    href="#">
                        ...
                        <ul>
                            ...
                            <li class="mb-6">
                                <a class="text-gray-50 hover:text-gray-200"
                                    href="#">{{ __('FAQs') }}</a></li>
                            <li>
                                <a class="text-gray-50 hover:text-gray-200" href="{{ route('front.contact') }}">
                    ...
                    <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-4">
                        <h3 class="mb-8 text-xl text-white font-bold font-heading border-b border-orange-400">
                            {{ __('Contact Us') }}</h3>
                        <ul>
                            <li class="mb-6">
