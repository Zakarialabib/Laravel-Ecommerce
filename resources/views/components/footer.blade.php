        ...
        <div class="w-full lg:w-3/5 px-4 mb-20">
          <div class="flex flex-wrap -mx-4">
            <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-10 lg:mb-0">
              ...
              <ul>
                <li class="mb-6"><a class="text-gray-50 hover:text-gray-200" href="#">{{__('Blog')}}</a></li>
            ...
            <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-10 lg:mb-0">
              ...
              <ul>
                ...
                <li class="mb-6"><a class="text-gray-50 hover:text-gray-200" href="#">{{__('FAQs')}}</a></li>
                <li class="mb-6"><a class="text-gray-50 hover:text-gray-200" href="#">{{__('Store Location')}}</a></li>
                <li><a class="text-gray-50 hover:text-gray-200" href="#">{{__('Contact Us')}}</a></li>
              </ul>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-4">
              ...
              <ul>
                <li class="mb-6">
                  <h4 class="mb-2 text-gray-50">{{__('Mobile')}}</h4>
                ...
                <li>
                  <h4 class="mb-2 text-gray-50">{{__('Live Chat')}}</h4>
