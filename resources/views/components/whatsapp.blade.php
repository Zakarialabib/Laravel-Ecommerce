@php
    ...
    $message = 'Question/Demande/Information sur les produits du site BadrLuxury.com';
...
<div class="fixed z-90 bottom-10 right-10 flex justify-center items-center text-white">
    <a href="{{ $url }}" target="_blank"
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
        y="0px" width="293.5px" height="293.5px" viewBox="0 0 293.5 293.5" enable-background="new 0 0 293.5 293.5"
        xml:space="preserve">
        ...
        <g id="WhatsApp_Logo_Icon_1_">
            <g id="Icon_xA0_影像_1_">
                ...
                <image overflow="visible" width="587" height="587" id="Icon_xA0_影像"
                    xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAkwAAAJOCAYAAABFrFjIAAAACXBIWXMAABYlAAAWJQFJUiTwAAAA
...
LVqzK4rScGmabWQAGlKqKEbDRWlNFJ81hgYAAAAAGN3/F2AARC0jccnxSFwAAAAASUVORK5CYII="
