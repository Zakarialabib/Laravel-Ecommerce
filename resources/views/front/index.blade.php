...
<div class="relative container mx-auto px-4">
    <div class="flex flex-wrap -mx-4">
        <div class="w-full md:w-1/2 px-4 mb-12 lg:mb-0 pt-20 lg:py-32">
            <div class="max-w-md">
                <h2 class="mb-8 text-5xl lg:text-6xl font-semibold font-heading">Get 10% off site-wide when you spend $30
                    with code: new</h2>
                ...
                <div class="flex p-3">
                    ...
                    <div class="w-auto">
                        <img class="h-full lg:h-36 rounded-xl object-cover"
                            src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?crop=entropy&amp;cs=tinysrgb&amp;fm=jpg&amp;ixid=MnwzMzIzMzB8MHwxfHNlYXJjaHw1MHx8d2F0Y2h8ZW58MHx8fHwxNjY1NzgyMDM3&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1920"
                            alt="">
                    </div>
                </div>
            </div>
            <img class="mx-auto h-96 lg:h-auto"
                src="https://images.unsplash.com/photo-1528968620-57e0257ff360?crop=entropy&amp;cs=tinysrgb&amp;fm=jpg&amp;ixid=MnwzMzIzMzB8MHwxfHNlYXJjaHw2Mnx8d2F0Y2h8ZW58MHx8fHwxNjY1NzgyMDM3&amp;ixlib=rb-1.2.1&amp;q=80&amp;w=1920"
                alt="">
        </div>
    </div>
    <div class="w-full lg:w-5/6 xl:absolute left-0 bottom-0 right-0 bg-white py-12 px-8 lg:ml-auto">
        <div class="flex flex-wrap items-center justify-center -mx-2 -mb-12">
            <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
                <img class="mx-auto h-6" src="images/swatch-logo.png" alt="">
            </div>
            <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
            ...
            <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
                <img class="mx-auto h-6" src="images/casio.png" alt="">
            </div>
            <div class="w-1/2 md:w-1/3 lg:w-1/6 px-2 mb-12">
            ...
            <div class="flex flex-wrap -mx-3">
                ...
                <div class="w-full lg:w-1/3 px-3 mb-16 lg:mb-0">
                    <a class="block mb-10" href="">
                        ...
                        <div class="mt-12">
                            <div class="mb-2">
                                <h3 class="mb-3 text-3xl text-white font-bold font-heading text-blue-900">{{ $product->name }}
                                </h3>
        ...
        <div class="relative py-20 md:py-40 bg-orange-300">
            ...
            <div class="relative text-center">
                <div class="inline-block px-4 relative mb-6">
                    ...
                    <h2 class="relative text-7xl font-bold font-heading text-white">Every Friday</h2>
                </div>
                <p class="mb-12 text-2xl font-bold font-heading text-white uppercase italic">student discount (10%)</p>
