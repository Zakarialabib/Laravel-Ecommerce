        ...
        <div class="z-50 fixed top-0 right-0 bottom-0 w-full max-w-xl bg-white overflow-y-scroll">
            <div class="p-6 md:pt-12 md:pb-6 md:px-12 bg-white">
                <div class="text-right">
                    <a class="inline-block ml-auto" href="#">
                        <svg width="17" height="18" viewbox="0 0 17 18" fill="none"
                            ...
                            <rect x="12.0273" y="4.53223" width="2" height="12"
                                transform="rotate(45 12.0273 4.53223)" fill="#161616"></rect>
                            <rect x="13.4336" y="13.0186" width="2" height="12"
                                transform="rotate(135 13.4336 13.0186)" fill="#161616"></rect>
                        </svg>
                    </a>
                </div>
                <div class="flex mb-12 items-center">
                    ...
                    <span
                        class="inline-flex ml-4 items-center justify-center w-8 h-8 rounded-full bg-orange-300 text-base font-bold font-heading text-white">2</span>
                </div>
            ...
            <div class="p-6 md:p-12 bg-orange-900">
                ...
                <h4 class="mb-2 text-xl font-bold font-heading text-white">{{ __('Shipping') }}</h4>
                <div class="flex mb-2 justify-between items-center">
                    <span class="text-blue-50">{{ __('Next day') }}</span>
                    <span class="text-xl font-bold font-heading text-white">$11.00</span>
                </div>
                <div class="flex mb-10 justify-between items-center">
                    <span class="text-blue-50">{{ __('Shipping to') }} United States</span>
                    <span class="text-xl font-bold font-heading text-white">-</span>
                </div>
                <div class="flex mb-10 justify-between items-center">
                    <span class="text-xl font-bold font-heading text-white">{{ __('Order total') }}</span>
