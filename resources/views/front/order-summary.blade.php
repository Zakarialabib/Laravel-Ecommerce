          ...
          <div class="container mx-auto px-10">
            <div class="flex items-end justify-end">
              <div class="w-full lg:w-3/5 lg:pl-20 lg:ml-auto">
                <h2 class="mb-8 text-5xl font-bold font-heading">{{__('Thanks for ordering')}}</h2>
                <p class="mb-12 text-gray-500">{{__('Your payment went through')}}</p>
                ...
                <div class="mb-6 p-10 shadow-xl">
                  <div class="flex flex-wrap items-center -mx-4">
                    <div class="w-full lg:w-2/6 px-4 mb-8 lg:mb-0">
                      <img class="w-full h-32 object-contain" src="yofte-assets/images/waterbottle.png" alt="">
                    </div>
                      ...
                      <div class="flex">
                        <div class="mr-auto">
                          ...
                          <p class="text-gray-500">
                            <span>Quantity:</span>
                            <span class="text-gray-900 font-bold font-heading">6</span>
                          </p>
                        </div>
                ...
                <div class="mb-10 p-10 shadow-xl">
                  <div class="flex flex-wrap items-center -mx-4">
                    <div class="w-full lg:w-2/6 px-4 mb-8 lg:mb-0">
                      <img class="w-full h-32 object-contain" src="yofte-assets/images/waterbottle.png" alt="">
                    </div>
                ...
                <div class="mb-10 py-10 px-4 bg-gray-100">
                  <div class="flex flex-wrap justify-around -mx-4">
                    ...
                    <div class="w-full md:w-auto px-4">
                      <h4 class="mb-6 font-bold font-heading">{{__('Payment Informations')}}</h4>
                ...
                <a class="block text-center px-8 py-4 bg-orange-300 hover:bg-orange-400 text-white font-bold font-heading uppercase rounded-md transition duration-200" href="#">Go back Shopping</a>
              </div>
            </div>
          </div>
        </div>
