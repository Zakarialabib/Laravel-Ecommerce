                ...
                <div class="flex flex-wrap -mx-3 space-y-0">
                    ...
                    <div class="xl:w-1/2 md:w-1/2 px-3">
                        ...
                        <x-select-list
                            ...
                            id="category_id" name="category_id" wire:model="blog.category_id" :options="$this->categories" />
                    ...
                    <div class="xl:w-1/2 md:w-1/2 px-3">
                        ...
                        <x-select-list
                            class="block bg-white text-gray-700 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                            id="language_id" name="language_id" wire:model="blog.language_id" :options="$this->languages" />
                    ...
                    <div class="w-full px-3 mb-4">
                        ...
                        <x-input.rich-text wire:model.defer="blog.details" id="details" name="details"
                            endpoint="/uploads" {{-- value="{!! $this->blog->details !!}" --}} placeholder="Content here..." />
                    </div>
                    <div class="xl:w-1/2 md:w-1/2 px-3">
