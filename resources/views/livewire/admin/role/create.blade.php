<div>
    ...
    <form wire:submit.prevent="submit" class="pt-3">
        ...
        <div class="mb-4 {{ $errors->has('role.title') ? 'is-invalid' : '' }}">
            ...
            <input class="p-3 leading-5 bg-white text-gray-700 dark:text-gray-300 rounded border border-zinc-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500" type="text" name="title" id="title" required wire:model.defer="role.title">
        ...
        <div class="mb-4 {{ $errors->has('permissions') ? 'is-invalid' : '' }}">
            ...
            <x-select-list class="p-3 leading-5 bg-white text-gray-700 dark:text-gray-300 rounded border border-zinc-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500" required id="permissions" name="permissions" wire:model.lazy="permissions"
