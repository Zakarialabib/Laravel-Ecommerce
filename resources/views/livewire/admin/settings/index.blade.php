            ...
            <div class="w-full flex flex-wrap">
                <div class="lg:w-1/2 sm:w-full px-2 @error('company_name') has-error @enderror">
                    ...
                    <input type="text" wire:model="company_name"
                        ...
                        id="company_name" value="{{ config('settings.company_name') }}"
                ...
                <div class="lg:w-1/2 sm:w-full mt-2 px-2 @error('company_phone') has-error @enderror">
                    ...
                    <input
                        class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                        wire:model="company_phone" type="text" value="{{ config('settings.company_phone') }}"
                        placeholder="{{ __('Enter your company phone') }}" id="company_phone" name="company_phone" />
                ...
                <div class="w-full mt-2 px-2 @error('company_address') has-error @enderror">
                    ...
                    <input
                        class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"
                        wire:model="company_address" type="text" value="{{ config('settings.company_address') }}"
            ...
            <div class="w-full flex flex-wrap">
                ...
                <div class="lg:w-1/2 sm:w-full px-2 @error('social_instagram') has-error @enderror">
                    ...
                    <input
                        ...
                        value="{{ config('settings.social_instagram') }}" id="social_instagram"
            ...
            <div class="flex flex-wrap mb-4">
                ...
                <div class="lg:w-1/2 sm:w-full px-2">
                    ...
                    <input
                        ...
                        value="{{ config('settings.currency_position') }}" id="currency_position"
            ...
            <div class="w-full">
                <div class="mb-4 px-2 @error('footer_copyright_text') has-error @enderror">
                    ...
                    <input
                        ...
                        value="{{ config('settings.footer_copyright_text') }}" id="footer_copyright_text"
