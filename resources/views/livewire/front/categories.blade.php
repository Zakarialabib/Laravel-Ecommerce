        ...
        <div class="mb-10 items-center justify-between bg-white py-4">
            <div class="w-full lg:mb-4 px-4 flex flex-wrap justify-between">
                <h2 class="lg:text-2xl sm:text-xl font-bold">
                    <span class="text-md mr-4"><a href="/">{{__('Home')}}</a> / <a href="{{ URL::current() }}">{{__('Categories')}}</a> </span>  {{ $products->where('status', 1)->count() }} {{ __('Watches') }}
                </h2>
            ...
            <div class="overflow-x-scroll flex py-2 sm:w-full py-2 lg:pl-5 sm:pl-0">
