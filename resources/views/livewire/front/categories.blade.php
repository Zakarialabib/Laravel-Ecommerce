        ...
        <div class="mb-4 items-center justify-between bg-white py-2">
            <div class="w-full px-4 flex flex-wrap justify-between">
                <div class="py-4 flex items-center flex-wrap">
                    <ul class="flex flex-wrap items-center text-md md:text-sm">
                        <li class="inline-flex items-center">
                            <a href="/" class="text-gray-600 hover:text-beige-500">
                        ...
                        <li class="inline-flex items-center">
                            <a href="{{ URL::current() }}" class="text-gray-600 hover:text-beige-500">
                                {{ __('Categories') }}
                            </a>
                            <span class="mx-2 h-auto text-gray-400 font-medium">/</span>
                        </li>
                        <li class="inline-flex items-center">
                            <p class="text-gray-600 hover:text-beige-500">
                        ...
                        <li class="inline-flex items-center ml-2">
                            <p class="lg:text-2xl sm:text-xl font-bold text-gray-600 hover:text-beige-500">
