    ...
    <section class="py-20">
        <div class="container mx-auto px-4">
                ...
                <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
                    <div class="relative mb-10" style="height: 564px;">
                        ...
                        <img class="object-cover w-full h-full"
                            src="images/pol-pl-Smartwatch-Amazfit-GTR-47-mm-Stainless-Steel-Xiaomi-A1902-4389-4.png"
                            alt="">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-1/2 sm:w-1/4 p-2">
                            <a class="block border border-blue-300" href="#">
                                <img class="w-full h-32 object-cover"
                                    src="images/smartwatch-xiaomi-amazfit-gtr-47mm-aluminium-b2a2d500acde431089f2588b8f3b12bc-c6df43ef.png"
                                    alt="">
                            </a>
                        </div>
                        <div class="w-1/2 sm:w-1/4 p-2">
                            <a class="block border border-transparent hover:border-gray-400" href="#">
                                <img class="w-full h-32 object-cover"
                                    src="images/smartwatch-xiaomi-amazfit-gtr-47mm-aluminium-c29dd8254f6f44f692f7ba99d2816eb5-b86e3f52.png"
                                    alt="">
                            </a>
                        </div>
                        <div class="w-1/2 sm:w-1/4 p-2">
                        ...
                        <div class="w-1/2 sm:w-1/4 p-2">
                            <a class="block border border-transparent hover:border-gray-400" href="#">
                                <img class="w-full h-32 object-cover"
                                    src="images/xiaomi-amazfit-gtr-47mm-aluminum-alloy-1009392-363335-8-Normal-Extra.jpg"
                                    alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="w-full md:w-1/2 px-4">
                    <div class="lg:pl-20">
                        ...
                        <div class="flex flex-wrap -mx-4 mb-14 items-center">
                            <div class="w-full xl:w-2/3 px-4 mb-4 xl:mb-0"><a
                                    class="block hover:bg-orange-400 text-center text-white font-bold font-heading py-5 px-8 rounded-md uppercase transition duration-200 bg-orange-500"
                            ...
                            <div class="w-full xl:w-1/3 px-4">
                                <a class="ml-auto sm:ml-0 flex-shrink-0 inline-flex mr-4 items-center justify-center w-16 h-16 rounded-md border hover:border-gray-500"
                                    href="#">
                                    <svg class="w-6 h-6" width="27" height="27" viewbox="0 0 27 27"
                                ...
                                <a class="flex-shrink-0 inline-flex items-center justify-center w-16 h-16 rounded-md border hover:border-gray-500"
                                    href="#">
                                    <svg class="w-6 h-6" width="24" height="23" viewbox="0 0 24 23"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div>
                ...
                <h3 class="mb-8 text-3xl font-bold font-heading text-orange-500">Summer collection and laoreet get</h3>
                <p class="max-w-2xl text-gray-500">I had interdum at ante porta, eleifend feugiat nunc. In semper
                    euismod mi a accums lorem sad. Morbi at auctor nibh. Aliquam tincidunt placerat mollis. Lorem
                    euismod dignissim, felis tortor ollis eros, non ultricies turpis.</p>
            </div>
        </div>
    </section>
</div>
