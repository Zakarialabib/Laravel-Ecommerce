<div>
    <div class="relative">
        <div class="fixed inset-0 overflow-hidden z-50" x-show="showCart" x-transition:enter="ease-in-out duration-500"
                        ...
                        <div class="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                            ...
                            <div class="p-6 md:p-12 bg-gray-900">
                                ...
                                <div class="flex mb-8 items-center justify-between pb-5 border-b border-blue-100">
                                    ...
                                    <span class="text-xl font-bold font-heading text-white">{{ $cartTotal }}
                                        DH</span>
                                </div>
