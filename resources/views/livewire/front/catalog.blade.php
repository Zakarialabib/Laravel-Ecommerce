                        ...
                        <div class="py-6 px-2 text-center bg-gray-50">
                            ...
                            <ul class="hidden text-left mt-6">
                                @foreach ($categories as $category)
                                    <li class="mb-2">
                                        <a class="font-bold font-heading" href="#">{{ $category->name }}</a>
                                ...
                                @foreach($brands as $brand)
                                    <div class="w-1/2 px-2 mb-2">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" class="form-checkbox" wire:model="brand_id">
            ...
            <div class="hidden lg:block w-1/4 px-3">
                <div class="mb-6 py-10 px-12 bg-gray-50">
                    ...
                    <ul>
                        ...
                        @foreach ($categories as $category)
                            <li class="mb-2">
                                <input type="hidden" value="{{ $category->id }}" wire:model="category_id">
                                <a class="font-bold font-heading" href="#">{{ $category->name }}</a>
                                <ul class="hidden text-left mt-2">
                                    @foreach ($category->subcategories as $subcategory)
                                        <li class="mb-2">
                                            <input type="hidden" value="{{ $subcategory->id }}" wire:model="subcategory_id">
                                            <a href="#">{{ $subcategory->name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
            ...
            @foreach ($products as $product)
                <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6 lg:mb-0">
                    <div class="p-6 bg-gray-50">
                        <span
                            class="px-2 py-1 text-xs font-bold font-heading border-2 border-red-500 rounded-full text-red-500 bg-white">-15%</span>
