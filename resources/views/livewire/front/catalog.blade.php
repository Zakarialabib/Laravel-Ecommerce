                        ...
                        <div class="py-6 px-2 text-center bg-gray-50">
                            ...
                            <ul class="hidden text-left mt-6">
                                @foreach ($categories as $category)
                                    <li class="mb-2">    
                                        <button wire:click="filterCategories({{ $category->id }})" class="bg-gray-200 text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded-full mr-2 mb-2">{{ $category->name }}</button>
                                        <ul class="hidden text-left mt-2">
                                            @foreach ($category->subcategories as $subcategory)
                                                <li class="mb-2">
                                                    <button wire:click="filterSubCategories({{ $subcategory->id }})" class="bg-gray-200 text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded-full mr-2 mb-2">{{ $subcategory->name }}</button>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                            ...
                            <div class="hidden mt-6 flex flex-wrap -mx-2 -mb-2">
                                @foreach ($brands as $brand)
                                    <div class="w-1/2 px-2 mb-2">
                                        <button wire:click="filterBrands({{ $brand->id }})" class="bg-gray-200 text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded-full mr-2 mb-2">{{ $brand->name }}</button>
                                    </div>
                                @endforeach
                            </div>
                        </div>
            ...
            <div class="hidden lg:block w-1/4 px-3">
                ...
                <div class="mb-6 py-12 pl-12 pr-6 bg-gray-50">
                    ...
                    <div class="flex flex-wrap -mx-2 -mb-2">
                        @foreach ($brands as $brand)
                        <div class="w-1/2 px-2 mb-2">
                            <x-button type="button" warning class="mx-2" wire:click="filterBrands({{ $brand->id }})" >{{ $brand->name }}</x-button>
                        </div>
                        @endforeach
                    </div>
                </div>
