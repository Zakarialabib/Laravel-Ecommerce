    ...
    <section class="relative py-24 md:py-44 lg:py-64 bg-white">
        <div class="relative z-10 px-4 mx-auto">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="mb-12 text-lg md:text-xl text-coolGray-500">{{ __('Page not found') }}</p>
        ...
        <img class="absolute top-0 left-0 w-28 md:w-auto" src="{{ asset('images/elements/wave2-yellow.svg') }}"
            alt="">
        <img class="absolute right-6 top-6 w-28 md:w-auto" src="{{ asset('images/elements/dots3-green.svg') }}"
            alt="">
        <img class="absolute right-0 bottom-0 w-28 md:w-auto" src="{{ asset('images/elements/wave3-red.svg') }}"
            alt="">
        <img class="absolute left-6 bottom-6 w-28 md:w-auto" src="{{ asset('images/elements/dots3-violet.svg') }}"
            alt="">
    </section>
@endsection
